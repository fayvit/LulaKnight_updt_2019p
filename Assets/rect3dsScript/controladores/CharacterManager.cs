...
#pragma warning restore 0649
    ...
    void Start()
    {
        ...
        EventAgregator.AddListener(EventKey.boolDescendoPulo, OnDownJump);
    ...
    private void OnDestroy()
    {
        ...
        EventAgregator.RemoveListener(EventKey.boolDescendoPulo, OnDownJump);
        EventAgregator.RemoveListener(EventKey.animationPointCheck, OnFinishJump);
    }

    private void OnDownJump(IGameEvent e)
    {
        if (e.Sender.transform == transform)
        {
            animador.EstouDescendo();
    ...
    private void OnStartCheckPoint(IGameEvent e)
    {
        ...
        dados.ultimoCheckPoint = new UltimoCheckPoint()
        {
            ...
            Pos = MelhoraPos.NovaPos(e.Sender.transform.position,0.1f)+Vector3.up
        };
    ...
    private void OnRequestFillDates(IGameEvent e)
    {
        ...
        if (S == null)
        {
            ...
            transform.position = GlobalController.InitialGamePosition;
        }
        else
        {
            Dados = S.Dados;
