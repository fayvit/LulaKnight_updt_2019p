...
#pragma warning restore 0649
    ...
    void ChangeSelectedOption()
    {
        if (!selectedYes)
        {
            seletorDoBotaoNao.color= new Color(1,1,1,1f);
            seletorDoBotaoSim.color = new Color(1, 0, 0, 1);
        }
        else
        {
            seletorDoBotaoSim.color = new Color(1, 1, 1, 1f);
            seletorDoBotaoNao.color = new Color(1, 0, 0, 1);
        }
