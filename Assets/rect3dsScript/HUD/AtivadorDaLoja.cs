...
public class AtivadorDaLoja : AtivadorDeBotao
{
    ...
    public void BtnComprar()
    {
        if (estado==EstadoDaqui.mudandoOpcao)
        {
            ...
            {
                string mens = BancoDeTextos.RetornaFraseDoIdioma(ChaveDeTexto.comunsDeLoja);
                GlobalController.g.UmaMensagem.ConstroiPainelUmaMensagem(RetornoDeMensagem, mens);
            }
