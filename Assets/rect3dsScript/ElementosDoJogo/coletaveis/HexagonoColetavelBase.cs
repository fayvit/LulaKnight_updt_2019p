...
public class HexagonoColetavelBase
{
    ...
    void OnCloseFirstPanel()
    {
        ...
        {
            CoroutineObject.Instance.StartCoroutine(PainelAoFimDoQuadro());
        }
        else
        {
    ...
    public void Coletou(bool ePentagono,string ID)
    {
        ...
        painel.ConstroiPainelDosPentagonosOuHexagonos(OnCloseFirstPanel,
            ePentagono ? PainelPentagonoHexagono.EstiloColetavel.militanteDePerseveranca :
            PainelPentagonoHexagono.EstiloColetavel.militanteDeCoragem);
    ...
    IEnumerator PainelAoFimDoQuadro()
    {
        ...
        painel.ConstroiPainelDosPentagonosOuHexagonos(OnCloseSecondPanel,
            ePentagono ? PainelPentagonoHexagono.EstiloColetavel.militanteDePerseveranca : PainelPentagonoHexagono.EstiloColetavel.militanteDeCoragem);
    }
}