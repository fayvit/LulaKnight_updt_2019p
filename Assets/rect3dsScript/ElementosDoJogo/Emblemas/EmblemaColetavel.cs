...
public class EmblemaColetavel : AtivadorDeBotao
{
    ...
    [SerializeField] private Text tituloColetou = null;
    ...
    public override void FuncaoDoBotao()
    {
        ...
        descricaoDoEmblema.text = BancoDeTextos.RetornaListaDeTextoDoIdioma(ChaveDeTexto.botonsInfo)[idDoEmblema];
        tituloColetou.text = BancoDeTextos.RetornaListaDeTextoDoIdioma(ChaveDeTexto.frasesDeBotons)[7];

        /* Texture2D t2d = (Texture2D)Resources.Load(nome.ToString());
         Debug.Log(t2d+" :"+ nome.ToString());
         Sprite S = Sprite.Create(t2d, new Rect(0, 0, t2d.width, t2d.height), t2d.texelSize);*/

        Sprite S = Resources.Load <Sprite>(nome.ToString());
