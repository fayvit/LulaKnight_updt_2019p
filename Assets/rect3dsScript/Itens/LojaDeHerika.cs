...
public class LojaDeHerika : Loja
{
    ...
    protected override void TextosDoNadaParaVender()
    {
        ...
        EventAgregator.Publish(new StandardSendGameEvent(EventKey.requestChangeShiftKey, KeyShift.primeiraFraseDeEstoqueEsgotado));
        EventAgregator.Publish(new StandardSendGameEvent(EventKey.requestChangeShiftKey, KeyShift.comprarParaAjudarResistencia,false));
    }
