...
public class JumperStandardEnemy : RigidbodyMoveEnemy
{
    ...
    protected override void OnActionRequest()
    {
        ...
        EventAgregator.Publish(new StandardSendGameEvent(gameObject, EventKey.sendAnimationKey, AnimationKey.movimentacao, Vector3.zero));
        ...
        switch (estado)
        {
            ...
            case EstadoDaqui.telegrafandoPulo:
                ...
                if (TempoDecorrido > TEMPO_TELEGRAFANDO_PULO)
                {
                    ...
                    EventAgregator.Publish(new StandardSendGameEvent(gameObject, EventKey.sendAnimationKey, AnimationKey.jumpAnimate,true));
            ...
            case EstadoDaqui.pulando:
                ...
                {
                    EventAgregator.Publish(new StandardSendGameEvent(gameObject, EventKey.sendAnimationKey, AnimationKey.jumpAnimate, false));
