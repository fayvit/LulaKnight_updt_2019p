...
public enum ChaveDeTexto
{
    ...
    frasesDeColetaveis,
    atravessouTecidoDoTempo,
    EstatuasDeValor,
    ocupacaoResiste,
    resgatandoComerciante,
    naoDeixeDeMeProcurar,
    caminhoAdiante,
    conhecimentoSobreTecidoDoTempo,
    comoViajarNoEspaco,
    ...
    companheiraDosEspolios,
    mantendoEstoque,
    obrigadoPorResgatarManu,
    comprarParaAjudarResistencia,
    estoqueEsgotado,
    comunsDeLoja
}
